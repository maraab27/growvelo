    ...
    <div className="sticky top-4 z-50 flex justify-center px-4">
      <header className="glass flex w-full max-w-5xl items-center justify-between px-4 py-2.5 sm:px-6">
        ...
        <nav className="hidden items-center gap-8 text-sm text-white/75 md:flex">
          ...
          <Link to="/pricing" className="transition hover:text-white" activeProps={{ className: "text-white" }}>Pricing</Link>
        </nav>
        ...
        <div className="glass-strong glass-hover relative overflow-hidden p-3 sm:p-4">
          ...
          <div className="relative rounded-[1.2rem] border border-white/10 bg-black/30 p-6 sm:p-10">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              />
              <MockCard label="Goal" title="Hit 50k signups" progress={0.67} />
              <MockCard label="Idea" title="Send stickers to top users" accent />
            </div>
          </div>
        </div>
      ...
      {progress !== undefined && (
        <div className="mt-5">
          <div className="h-1.5 w-full overflow-hidden rounded-full bg-white/10">
            <div className="h-full gradient-accent" style={{ width: `${progress * 100}%` }} />
          </div>
            ...
            <ul className="mt-3 space-y-1.5">
              {items.map((it, i) => (
                ...
                >
                  ...
                  <button aria-label="toggle visibility" className="text-white/50 transition hover:text-white">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-6">
          <BoardTile className="md:col-span-4 corner-frame" editor>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              {["Draft press release", "Design hero art", "Ship changelog", "Post to socials"].map((t, i) => (
                <div key={t} className="glass-chip flex items-center gap-2 px-3 py-2 text-sm text-white/85">
                  <span
          ...
          <div className="md:col-span-2 tilt-sm-r">
            <BoardTile gradient>
              <div className="flex items-center justify-between">
                <div className="text-[10px] font-medium uppercase tracking-[0.22em] text-white/70">Goal</div>
          ...
          <BoardTile className="md:col-span-2">
            <div className="flex items-center justify-between">
              <div className="text-[10px] font-medium uppercase tracking-[0.22em] text-white/50">Reminder</div>
              <span className="mono-readout">10:00 AM</span>
            </div>
            <div className="mt-2 font-display text-lg font-semibold text-white">Standup at 10:00</div>
            <div className="mt-1 text-sm text-white/60">Bring the doughnuts.</div>
          </BoardTile>

          <div className="md:col-span-2 tilt-sm-r">
            <BoardTile>
              <div className="text-[10px] font-medium uppercase tracking-[0.22em] text-white/50">Idea</div>
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: "linear-gradient(180deg, rgba(255,255,255,0.16), transparent 80%)",
        }}
      />
        ...
        <div className="mt-16 grid grid-cols-2 gap-5 sm:grid-cols-3 md:grid-cols-5">
          {cats.map((c) => (
            <div key={c.label} className="glass glass-hover flex flex-col items-center gap-3 p-6">
              ...
              <div className="text-[10px] uppercase tracking-[0.2em] text-white/50">24 templates</div>
            </div>
          ))}
        </div>
    ...
    <section className="relative py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-5">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-5 font-display text-4xl font-semibold sm:text-5xl md:text-6xl">
            Teams are <span className="text-gradient-accent">obsessed</span>.
          </h2>
        </div>
          ...
          {quotes.map((t, i) => (
            ...
            >
              <div
                ...
                style={{
                  background: "linear-gradient(180deg, rgba(255,255,255,0.14), transparent 80%)",
                }}
              />
              <div className="relative">
                <div className="text-gradient-accent font-display text-5xl leading-none">&ldquo;</div>
                <blockquote className="mt-2 text-lg leading-snug text-white/90">{t.q}</blockquote>
      ...
      <div className="relative mx-auto max-w-4xl px-5">
        <div className="glass-strong relative overflow-hidden px-8 py-16 text-center sm:px-16 sm:py-20">
          <div
            ...
            style={{
              background: "linear-gradient(180deg, rgba(255,255,255,0.2), transparent 80%)",
            }}
          />
          <div className="relative">
            ...
            <h2 className="mx-auto mt-6 max-w-2xl font-display text-4xl font-semibold sm:text-5xl md:text-6xl">
              Ready to make work <span className="text-gradient-accent">feel like yours</span>?
            </h2>
    ...
    <footer className="relative border-t border-white/10 py-14">
      <div className="mx-auto flex max-w-7xl flex-col items-start gap-8 px-5 md:flex-row md:items-center md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-x-10 gap-y-2 text-sm sm:grid-cols-4">
          <Link to="/product" className="text-white/80 transition hover:text-white">Product</Link>
          <Link to="/templates" className="text-white/80 transition hover:text-white">Templates</Link>
          <Link to="/pricing" className="text-white/80 transition hover:text-white">Pricing</Link>
          <Link to="/showcase" className="text-white/80 transition hover:text-white">Showcase</Link>
