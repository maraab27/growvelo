...
TrxID: ${formData.trxId}`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/70 backdrop-blur-md animate-in fade-in duration-200">
      <div
        className="glass-strong rounded-2xl sm:rounded-3xl max-w-lg w-full p-5 sm:p-8 border border-border/80 shadow-2xl relative max-h-[92vh] overflow-y-auto font-bangla"
      ...
      >
        ...
        {!isSubmitted ? (
          <>
            ...
            <div className="glass rounded-xl p-3.5 border border-primary/20 bg-primary/5 mb-5 space-y-2">
              ...
              <div className="flex items-center justify-between gap-2 bg-background/50 p-2 sm:p-2.5 rounded-lg border border-border/50">
                ...
                <button
                  type="button"
                  onClick={handleCopy}
                  className="px-2.5 py-1 text-xs rounded-lg glass font-sans flex items-center gap-1.5 text-foreground hover:bg-primary hover:text-primary-foreground transition-colors font-medium"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5 text-xs sm:text-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl glass border border-border/80 focus:outline-none focus:border-primary text-foreground text-xs sm:text-sm bg-background font-sans"
                  >
              ...
              <button
                type="submit"
                className="w-full mt-4 py-3 sm:py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold text-sm sm:text-base flex items-center justify-center gap-2 shadow-md hover:brightness-110 active:scale-[0.99] transition-all cursor-pointer"
              >
          ...
          <div className="py-6 sm:py-8 text-center space-y-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-emerald-500/10 text-emerald-500 rounded-full flex items-center justify-center mx-auto">
              <CheckCircle2 className="w-7 h-7 sm:w-8 sm:h-8" />
            </div>
            <h3 className="font-bangla text-lg sm:text-xl font-bold text-foreground">
              <EditableText id={`course.${courseSlug}.modal.success.title`}>রিকোয়েস্ট প্রস্তুত হয়েছে!</EditableText>
            </h3>
            <p className="font-bangla text-xs sm:text-sm text-muted-foreground max-w-sm mx-auto leading-relaxed">
            ...
            <button
              onClick={onClose}
              className="px-5 py-2 rounded-xl glass text-xs sm:text-sm font-semibold text-foreground hover:bg-muted transition-colors cursor-pointer"
            >
              উইন্ডো বন্ধ করুন
            </button>
          </div>
...
// ================= ট্যাব ১: ওভারভিউ (মিনিমাল ন্যাচারাল আইকন ও রিফাইন্ড টাইটেল) =================
function TabOverview({ courseSlug }: { courseSlug: string }) {
  return (
    <div className="space-y-8 sm:space-y-10 animate-in fade-in duration-300 font-bangla">
      ...
      {/* টাইটেল সাইজ সুবিন্যস্ত ও চোখের জন্য আরামদায়ক করা হলো */}
      <div className="max-w-2xl mx-auto text-center flex flex-col items-center px-1">
        <div className="inline-flex items-center gap-2 px-3 py-0.5 rounded-full glass border border-primary/20 bg-primary/5 text-primary text-[11px] sm:text-xs font-medium tracking-wide mb-3">
        ...
        <h2 className="font-bangla font-bold tracking-tight text-foreground text-lg sm:text-2xl lg:text-[1.65rem] leading-[1.3] break-words">
          <EditableText id={`course.${courseSlug}.painpoint.heading`}>
            ভিডিও এখন সব জায়গায়, কিন্তু ইন্ডাস্ট্রি স্ট্যান্ডার্ড এডিটরের অভাব কেন?
          </EditableText>
        </h2>

        <p className="font-bangla text-muted-foreground text-xs sm:text-sm leading-relaxed mt-2.5 max-w-xl">
      ...
      {/* ৩টি কার্ড: কোনো কৃত্রিম এআই বক্স ছাড়া স্লিক ও মিনিমাল ডিজাইন */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
        
        {/* কার্ড ১ */}
        <div className="glass p-5 rounded-2xl border border-border/60 hover:-translate-y-1 transition-all duration-200 flex flex-col justify-between group shadow-xs">
          <div>
            <div className="w-9 h-9 rounded-xl bg-foreground/[0.04] border border-border/50 flex items-center justify-center text-foreground/80 mb-3.5 transition-colors group-hover:border-primary/40 group-hover:text-primary">
              <TrendingUp className="w-4 h-4" />
            </div>
            <h3 className="font-bangla font-bold text-sm sm:text-base text-foreground leading-snug">
              <EditableText id={`course.${courseSlug}.card.1.title`}>
                সবাই কনটেন্ট বানাচ্ছে, কিন্তু রিটেনশন পাচ্ছে কয়জন?
              </EditableText>
            </h3>
            <p className="font-bangla text-xs text-foreground/75 leading-relaxed mt-2">
          ...
          <div className="pt-3.5 mt-4 border-t border-border/40 flex items-center gap-1.5 text-[11px] sm:text-xs font-medium text-muted-foreground group-hover:text-primary transition-colors">
      ...
      <div className="glass rounded-2xl border border-border/70 p-5 sm:p-7 relative overflow-hidden backdrop-blur-md">
        <div className="text-center mb-5">
          <h3 className="font-bangla text-sm sm:text-base font-bold text-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 divide-y md:divide-y-0 md:divide-x divide-border/60">
          <div className="space-y-3 pt-3 md:pt-0">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-destructive/10 text-destructive text-[11px] font-semibold">
              <span><EditableText id={`course.${courseSlug}.compare.bad.badge`}>সাধারণ এডিটর (YouTube Learner)</EditableText></span>
            </div>
            <ul className="space-y-2 font-bangla text-xs text-foreground/75">
          ...
          <div className="space-y-3 pt-4 md:pt-0 md:pl-6">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 text-[11px] font-semibold">
            ...
            <ul className="space-y-2 font-bangla text-xs text-foreground/90 font-medium">
              <li className="flex items-start gap-2">
...
// ================= ট্যাব ২: কারিকুলাম (সাইজ ব্যালান্সড) =================
function TabCurriculum({ courseSlug }: { courseSlug: string }) {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-300 font-bangla">
      <div className="max-w-2xl mx-auto text-center flex flex-col items-center px-1">
        <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full glass border border-primary/20 bg-primary/5 text-primary text-[11px] sm:text-xs font-medium tracking-wide mb-3">
          <Sparkles className="w-3 h-3" />
        ...
        <p className="font-bangla text-muted-foreground text-xs sm:text-sm leading-relaxed mt-2 max-w-lg">
          ...
          return (
            ...
            >
              <button
                ...
                className="w-full p-4 sm:p-4.5 text-left flex items-start sm:items-center justify-between gap-3 transition-colors select-none cursor-pointer"
              >
                <div className="flex items-start sm:items-center gap-3 min-w-0 flex-1">
                  <div className={`p-1.5 sm:p-2 rounded-lg shrink-0 transition-colors ${
                    isOpen ? "bg-primary text-primary-foreground" : "bg-foreground/5 text-foreground/70"
                  }`}>
                    <BookOpen className="w-3.5 h-3.5" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <span className="text-[10px] sm:text-[11px] font-mono uppercase tracking-wider font-semibold text-primary block mb-0.5">
                      <EditableText id={`course.${courseSlug}.module.${idx + 1}.no`}>{item.moduleNo}</EditableText>
                    </span>
                    <h3 className="font-sans font-bold text-xs sm:text-sm text-foreground truncate">
                      <EditableText id={`course.${courseSlug}.module.${idx + 1}.title`}>{item.title}</EditableText>
                    </h3>
                  </div>
                </div>

                <div className={`p-1 rounded-md glass text-muted-foreground shrink-0 transition-transform duration-300 ${
              ...
              {isOpen && (
                <div className="px-4 pb-4 sm:px-5 sm:pb-5 pt-1 border-t border-border/30 animate-in fade-in duration-200">
                  <p className="font-bangla text-xs text-muted-foreground mb-2.5 leading-relaxed">
                    <EditableText id={`course.${courseSlug}.module.${idx + 1}.desc`}>{item.desc}</EditableText>
                  </p>
                  
                  <div className="bg-background/60 rounded-xl p-2.5 sm:p-3 border border-border/40 space-y-1.5">
                    {item.lessons.map((lesson, lIdx) => (
                      <div key={lIdx} className="flex items-center gap-2 font-bangla text-[11px] sm:text-xs text-foreground/85">
    ...
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-300 font-bangla">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
        {features.map((feat, fIdx) => (
          <div
            key={fIdx}
            className="glass p-4 sm:p-5 rounded-2xl border border-border/60 hover:-translate-y-1 transition-all duration-200 flex flex-col justify-between group shadow-xs"
          >
            <div>
              <div className="w-8 h-8 rounded-lg bg-foreground/[0.04] border border-border/50 flex items-center justify-center text-foreground/80 mb-3 group-hover:border-primary/40 group-hover:text-primary transition-colors">
              ...
              <p className="font-bangla text-xs text-foreground/75 leading-relaxed mt-1.5">
                <EditableText id={`course.${courseSlug}.feature.${fIdx + 1}.desc`}>{feat.descKey}</EditableText>
              </p>
            </div>

            <div className="pt-3 mt-3.5 border-t border-border/40 flex items-center gap-1.5 text-[11px] font-medium text-emerald-600 dark:text-emerald-400">
    ...
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-300 font-bangla">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 relative">
        {steps.map((item, index) => (
          <div
            key={index}
            className="glass p-5 rounded-2xl border border-border/60 hover:-translate-y-1 transition-all duration-200 flex flex-col justify-between group shadow-xs relative overflow-hidden"
          >
            <span className="absolute -top-3 right-2.5 font-mono font-black text-5xl text-foreground/[0.03] select-none pointer-events-none group-hover:text-primary/10 transition-colors">
              {item.step}
            </span>

            <div>
              <div className="flex items-center justify-between mb-3.5">
                <div className="w-8 h-8 rounded-lg bg-foreground/[0.04] border border-border/50 flex items-center justify-center text-foreground/80 group-hover:border-primary/40 group-hover:text-primary transition-colors">
                  <item.icon className="w-4 h-4" />
                </div>
                <span className="px-2 py-0.5 rounded-full glass border border-primary/20 bg-primary/5 text-primary font-mono text-[10px] font-bold">
                  Step {item.step}
                </span>
              </div>

              <span className="text-[10px] sm:text-[11px] font-bangla font-semibold text-primary block mb-1">
            ...
            <div className="pt-3 mt-3.5 border-t border-border/40 flex items-center gap-1.5 text-[11px] font-medium text-muted-foreground group-hover:text-primary transition-colors">
          ...
          return (
            ...
            >
              <button
                ...
                className="w-full p-3.5 sm:p-4 text-left flex items-start justify-between gap-3 select-none cursor-pointer"
              >
                <span className="font-bangla font-bold text-xs sm:text-sm text-foreground leading-snug">
                  <EditableText id={`course.${courseSlug}.faq.item.${i + 1}.q`}>{faq.q}</EditableText>
                </span>
                <div
                  className={`p-1 rounded-md glass text-muted-foreground shrink-0 transition-transform duration-300 ${
                    isOpen ? "rotate-180 text-primary" : ""
                  }`}>
                  <ChevronDown className="w-3.5 h-3.5" />
                </div>
              ...
              {isOpen && (
                <div className="px-3.5 pb-4 sm:px-4 sm:pb-4 pt-1 border-t border-border/30 animate-in fade-in duration-200">
...
function CourseDetail() {
  ...
  return (
    <SiteShell>
      ...
      {showLockedModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-black/60 backdrop-blur-sm font-bangla">
          <div className="sticky-card tint-brand relative w-full max-w-md overflow-hidden p-5 sm:p-7">
            <button
            ...
            <h2 className="mt-3 font-bangla text-lg font-bold">এই লেসনটি লক করা আছে</h2>
            <p className="mt-1.5 text-xs sm:text-sm text-foreground/70 leading-relaxed">
            ...
            <div className="mt-6 space-y-2.5">
              <button
                ...
                className="gloss-btn w-full justify-center text-xs sm:text-sm cursor-pointer"
              >
                এখনই এনরোল করুন
              </button>
              <button
                onClick={() => setShowLockedModal(false)}
                className="w-full py-1.5 text-xs font-medium text-foreground/50 hover:text-foreground cursor-pointer"
              >
                পরে দেখব
              </button>
            </div>
      ...
      <section className="bg-background min-h-screen pt-20 sm:pt-28 pb-14 sm:pb-20 overflow-x-hidden">
        <div className="mx-auto max-w-7xl px-3.5 sm:px-6 lg:px-8">
          
          {/* All courses লিঙ্ক */}
          <Link
            to="/courses"
            className="mb-5 inline-flex items-center gap-1.5 text-[11px] sm:text-xs font-mono tracking-wider uppercase transition-opacity hover:opacity-60 text-foreground/60"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-start mb-12 sm:mb-16">
            ...
            <div className="lg:col-span-7 flex flex-col space-y-4 sm:space-y-5 font-bangla min-w-0">
              
              <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-[4px] border border-border/80 bg-foreground/[0.04] w-fit shadow-2xs">
                <span className="h-1.5 w-1.5 rounded-[1px] bg-primary shrink-0"></span>
                <span className="text-[11px] sm:text-xs font-medium tracking-normal text-foreground/90 font-sans truncate">
              ...
              <h1 className="font-bangla font-extrabold tracking-tight text-foreground leading-[1.25] text-2xl sm:text-3xl lg:text-[2.6rem] break-words">
                <EditableText id={`course.${course.slug}.hero.title`}>
                  ভিডিও এডিটিংকে বানান আপনার ক্যারিয়ারের সেরা সুপারপাওয়ার
                </EditableText>
              </h1>

              <p className="font-bangla text-xs sm:text-sm text-foreground/80 leading-relaxed max-w-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                <div className="glass p-3.5 rounded-xl border border-border/60 flex items-start gap-3 hover:border-primary/30 transition duration-200">
                  <div className="p-2 rounded-lg bg-destructive/10 text-destructive shrink-0 mt-0.5">
                    <Radio className="w-4 h-4 animate-pulse" />
                  </div>
                  <div className="space-y-0.5 min-w-0">
                    <h3 className="font-bangla font-bold text-xs sm:text-sm text-foreground">
                      <EditableText id={`course.${course.slug}.benefit.1.title`}>
                        হাতে কলমে লাইভ সেশন
                      </EditableText>
                    </h3>
                    <p className="font-bangla text-[11px] text-foreground/75 leading-relaxed">
                ...
                <div className="glass p-3.5 rounded-xl border border-border/60 flex items-start gap-3 hover:border-primary/30 transition duration-200">
                  <div className="p-2 rounded-lg bg-accent/20 text-foreground shrink-0 mt-0.5">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-24 w-full">
              <div className="glass-strong rounded-2xl sm:rounded-3xl p-5 sm:p-6 border border-border/60 shadow-xl overflow-hidden backdrop-blur-md">
                
                <div className="relative aspect-video w-full rounded-xl sm:rounded-2xl overflow-hidden border border-border/40 group mb-4 sm:mb-5">
                  <EditableImage
                  ...
                  <div className="absolute inset-0 bg-black/35 flex items-center justify-center group-hover:bg-black/25 transition-colors">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full glass flex items-center justify-center text-white border border-white/20 shadow-lg group-hover:scale-110 transition-transform">
                      <Play className="w-4 h-4 sm:w-5 sm:h-5 fill-white ml-0.5" />
                    </div>
                  </div>
                  <div className="absolute top-2.5 left-2.5">
                    <span className="px-2 py-0.5 rounded-[4px] text-[10px] font-medium bg-black/70 text-white backdrop-blur-md border border-white/10 font-sans">
                ...
                <div className="flex items-baseline justify-between mb-3.5">
                  <div className="flex items-baseline gap-2.5">
                    ...
                    <span className="text-sm sm:text-base text-muted-foreground/60 line-through decoration-rose-500/80 decoration-[1.5px] font-mono font-medium">
                      <EditableText id={`course.${course.slug}.oldPrice`}>৳৫,০০০</EditableText>
                    </span>
                  </div>

                  <span className="px-2.5 py-0.5 text-[11px] font-semibold rounded-[4px] bg-primary/10 text-primary border border-primary/20 font-sans">
                ...
                <div className="mb-4 p-2.5 sm:p-3 rounded-xl border border-amber-500/30 bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-transparent flex items-center justify-between shadow-xs">
                  <div className="flex items-center gap-1.5 font-sans font-medium text-[11px] sm:text-xs text-amber-600 dark:text-amber-400">
                  ...
                  <div className="flex items-center gap-1 font-mono text-xs sm:text-sm font-bold">
                    <span className="px-1.5 py-0.5 rounded-md bg-background/90 text-foreground border border-amber-500/20 shadow-xs">
                    ...
                    <span className="text-amber-500">:</span>
                    <span className="px-1.5 py-0.5 rounded-md bg-background/90 text-rose-600 dark:text-rose-400 border border-rose-500/20 shadow-xs">
                      {formatDigit(timer.seconds)}s
                    </span>
                  </div>
                </div>

                <div className="space-y-2.5 mb-5 border-y border-border/40 py-3.5 font-sans text-xs sm:text-sm">
                  ...
                  <div className="flex items-center justify-between gap-2 p-1.5 sm:p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/30 dark:bg-emerald-950/30 dark:border-emerald-500/40 transition-colors">
                    <div className="flex items-center gap-1.5 text-emerald-600 dark:text-emerald-400 font-medium">
                      <div className="flex h-5 w-5 items-center justify-center rounded-md bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 shrink-0">
                    ...
                    <span className="font-bold text-xs text-emerald-600 dark:text-emerald-400 text-right">
                ...
                {enrolled ? (
                  <Link
                    ...
                    className="gloss-btn w-full justify-center !py-3 text-sm sm:text-base font-bold cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-3 sm:py-3.5 px-4 rounded-xl bg-primary text-primary-foreground font-semibold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg shadow-primary/25 hover:brightness-110 active:scale-[0.99] transition-all duration-150 font-sans cursor-pointer"
                  >
                ...
                <p className="mt-2.5 text-center text-[11px] text-muted-foreground font-sans">
          ...
          {/* ================= ১. স্টিকি ট্যাব বার কন্ট্রোলার (সেন্টার অ্যালাইনড ও মোবাইল রেসপনসিভ) ================= */}
          <div className="sticky top-16 sm:top-20 z-30 mb-6 sm:mb-8 py-2 backdrop-blur-md">
            <div className="max-w-3xl mx-auto glass-strong p-1 sm:p-1.5 rounded-xl sm:rounded-2xl border border-border/80 shadow-md flex items-center justify-start sm:justify-center gap-1 overflow-x-auto no-scrollbar">
              {tabList.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-2 rounded-lg sm:rounded-xl font-sans text-xs sm:text-[13px] font-semibold transition-all whitespace-nowrap cursor-pointer select-none shrink-0 ${
                      isActive
          ...
          {/* ================= ২. ইউনিফাইড কন্টেন্ট মাস্টার কার্ড (মোবাইল প্যাডিং পারফেক্ট) ================= */}
          <div className="max-w-4xl mx-auto glass-strong rounded-2xl sm:rounded-3xl border border-border/80 p-4 sm:p-8 lg:p-10 shadow-lg mb-12 sm:mb-16 relative overflow-hidden backdrop-blur-md">
          ...
          <div className="relative max-w-4xl mx-auto font-bangla">
            <div className="glass-strong rounded-2xl sm:rounded-3xl border border-primary/30 p-6 sm:p-10 text-center shadow-xl relative overflow-hidden backdrop-blur-md">
              <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-80 h-80 bg-primary/10 rounded-full blur-3xl pointer-events-none" />

              <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full glass border border-primary/30 bg-primary/10 text-primary text-[11px] sm:text-xs font-semibold tracking-wide shadow-2xs mb-3.5">
                <Flame className="w-3 h-3 fill-primary text-primary animate-pulse" />
                <span><EditableText id={`course.${course.slug}.final.cta.badge`}>সীমিত সময়ের অফার</EditableText></span>
              </div>

              <h3 className="font-bangla font-extrabold text-lg sm:text-2xl lg:text-3xl text-foreground leading-[1.3] tracking-tight break-words">
                <EditableText id={`course.${course.slug}.final.cta.title`}>
                  দেরি না করে আজই আপনার সিনেমাটিক এডিটিং জার্নি শুরু করুন
                </EditableText>
              </h3>

              <p className="font-bangla text-xs sm:text-sm text-foreground/85 leading-relaxed mt-2.5 max-w-xl mx-auto">
              ...
              <div className="mt-6 flex flex-col items-center justify-center gap-2.5">
                <button
                  onClick={() => setShowModal(true)}
                  className="w-full sm:w-auto px-6 py-3 rounded-xl bg-primary text-primary-foreground font-semibold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg shadow-primary/25 hover:brightness-110 active:scale-[0.99] transition-all font-sans cursor-pointer"
                >
                  <span><EditableText id={`course.${course.slug}.final.cta.btn`}>Enroll in Batch 03 Now</EditableText></span>
                  <ArrowRight className="w-4 h-4" />
                </button>

                <p className="text-[11px] text-muted-foreground font-bangla flex items-center gap-1 mt-1">
