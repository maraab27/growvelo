...
function TabFaq({ courseSlug, isBatch1 }: { courseSlug: string; isBatch1: boolean }) {
  ...
  {
    q: "আমি একদম নতুন, আগে কখনো ভিডিও এডিটিং করিনি। আমি কি এই মাস্টারক্লাসটি করতে পারবো?",
    a: "অবশ্যই! এই মাস্টারক্লাসটি একদম বেসিক (স্ক্র্যাচ) থেকে ডিজাইন করা হয়েছে। আপনি যদি শুধু বেসিক কম্পিউটার চালাতেও জানেন, বাকিটা আমরা ধাপে ধাপে শিখিয়ে দেবো। জিরো থেকে প্রফেশনাল লেভেলে যাওয়ার সম্পূর্ণ প্র্যাকটিক্যাল রোডম্যাপ আপনি এখানেই পাবেন।"
  },
  {
    q: "প্র্যাকটিস করার জন্য আমার পিসি বা ল্যাপটপের কনফিগারেশন কেমন হতে হবে?",
    a: "খুব হাই-এন্ড পিসির প্রয়োজন নেই। কোর আই-৩ (Core i3) বা কোর আই-৫ (Core i5), ৮ জিবি র‍্যাম (8GB RAM) এবং একটি বেসিক গ্রাফিক্স কার্ড থাকলে আপনি অনায়াসে কাজ শুরু করতে পারবেন। আমরা সফটওয়্যার অপটিমাইজেশনও শিখিয়ে দেবো, যাতে লো-এন্ড পিসিতেও আপনি স্মুথলি কাজ করতে পারেন।"
  },
  {
    q: "মোবাইল দিয়ে কি এই মাস্টারক্লাসটি করা যাবে?",
    a: "আপনি চাইলে মোবাইল দিয়ে ক্লাসগুলো দেখতে পারবেন, কিন্তু প্র্যাকটিস করার জন্য এবং প্রফেশনাল লেভেলের কাজ শেখার জন্য আপনার অবশ্যই একটি পিসি বা ল্যাপটপ প্রয়োজন হবে। কারণ আমরা ইন্ডাস্ট্রি-স্ট্যান্ডার্ড সফটওয়্যার (যেমন: Premiere Pro) ব্যবহার করে প্রফেশনাল কাজ শিখবো।"
  },
  {
    q: "ক্লাসের রেকর্ডিং বা এক্সেস কতদিন থাকবে? আমি কি পরে ভিডিওগুলো দেখতে পারবো?",
    a: "হ্যাঁ! প্রতিটি লাইভ ক্লাসের পরপরই আপনার স্টুডেন্ট ড্যাশবোর্ডে হাই-কোয়ালিটি ক্লাউড রেকর্ডিং আপলোড করা হবে। আর এই এক্সেস থাকবে আজীবন (Lifetime Access)। তাই যেকোনো সময় আপনি ক্লাসগুলো পুনরায় দেখে রিভিশন দিতে পারবেন।"
  },
  {
    q: "প্র্যাকটিস করার সময় কোথাও আটকে গেলে সাপোর্ট পাবো কীভাবে?",
    a: "সাপোর্টই আমাদের সবচেয়ে বড় শক্তি! আমাদের প্রাইভেট ডিসকর্ড (Discord) কমিউনিটিতে আপনি সার্বক্ষণিক সাপোর্ট পাবেন। কোথাও আটকে গেলে স্ক্রিন শেয়ার করে সরাসরি মেন্টরের কাছ থেকে প্রবলেম সলভ করে নেওয়ার সুযোগ থাকবে।"
  },
  {
    q: "প্র্যাকটিস করার জন্য কি প্রজেক্ট ফাইল বা র-ফুটেজ দেওয়া হবে?",
    a: "১০০% দেওয়া হবে। রিয়েল-লাইফ ক্লায়েন্ট প্রজেক্টের ফুটেজ, প্রিমিয়াম সাউন্ড প্যাক (SFX), কালার লাটস (LUTs) এবং প্রিসেট ফাইল—সবকিছুই এই মাস্টারক্লাসের সাথে আপনাকে একদম ফ্রিতে প্রোভাইড করা হবে।"
  },
  {
    q: "মাস্টারক্লাস শেষ করার পর ক্লায়েন্ট বা কাজ পেতে কি কোনো গাইডলাইন পাবো?",
    a: "আমাদের লক্ষ্য শুধু টুলস শেখানো নয়, আপনাকে মার্কেট-রেডি করা। মাস্টারক্লাসের শেষের দিকে পোর্টফোলিও তৈরি থেকে শুরু করে লোকাল ও ইন্টারন্যাশনাল ক্লায়েন্ট হ্যান্ডলিং এবং আউটরিচ করার স্পেশাল গাইডলাইন সেশন থাকবে, যা আপনাকে কাজ পেতে সাহায্য করবে।"
  },
  {
    q: "মাস্টারক্লাসটি সফলভাবে শেষ করলে কি কোনো সার্টিফিকেট দেওয়া হবে?",
    a: "জি, কোর্সের সকল প্রজেক্ট এবং অ্যাসাইনমেন্ট সফলভাবে জমা দেওয়ার পর আপনাকে growVelo-এর পক্ষ থেকে একটি ভেরিফায়েড ডিজিটাল সার্টিফিকেট প্রদান করা হবে, যা আপনি আপনার সিভি (CV) বা লিঙ্কডইনে (LinkedIn) প্রফেশনাল স্কিল হিসেবে যুক্ত করতে পারবেন।"
  }
];
